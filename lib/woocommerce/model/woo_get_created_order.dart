...
WooGetCreatedOrder wooGetCreatedOrderFromJson(String str) =>
    WooGetCreatedOrder.fromJson(json.decode(str));

String wooGetCreatedOrderToJson(WooGetCreatedOrder data) =>
...
class WooGetCreatedOrder {
  ...
  factory WooGetCreatedOrder.fromJson(Map<String, dynamic> json) =>
      WooGetCreatedOrder(
        id: json["id"],
