class RetrieveCoupon {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (excludedProductIds != null) {
      map['excluded_product_ids'] =
          excludedProductIds?.map((v) => v.toJson()).toList();
    }
    ...
    if (excludedProductCategories != null) {
      map['excluded_product_categories'] =
          excludedProductCategories?.map((v) => v.toJson()).toList();
    }
    ...
    if (emailRestrictions != null) {
      map['email_restrictions'] =
          emailRestrictions?.map((v) => v.toJson()).toList();
    }
    if (usedBy != null) {
