...
class ProblemReportingCrossProjectModelAccess(
    ...
    override fun getSubprojects(
        referrer: ProjectInternal,
        relativeTo: ProjectInternal
    ): MutableSet<out ProjectInternal> {
        return delegate.getSubprojects(referrer, relativeTo)
            .mapTo(LinkedHashSet()) { it.wrap(referrer) }
    }
    ...
    override fun getAllprojects(
        ...
        return delegate.getAllprojects(referrer, relativeTo)
            .mapTo(LinkedHashSet()) { it.wrap(referrer) }
    }
    ...
    class ProblemReportingProject(
        ...
        override fun stepEvaluationListener(
