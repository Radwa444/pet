...
class DefaultBuildModelControllerServices(
    ...
    override fun servicesForBuild(
        buildDefinition: BuildDefinition,
        owner: BuildState,
        parentBuild: BuildState?
    ): BuildModelControllerServices.Supplier {
    ...
    class ConfigurationCacheBuildControllerProvider {
        fun createBuildModelController(
            ...
            val vintageController = VintageBuildControllerProvider().createBuildModelController(
                gradle,
    ...
    class VintageBuildControllerProvider {
        fun createBuildModelController(
            ...
            val taskSchedulingPreparer =
                DefaultTaskSchedulingPreparer(ExcludedTaskFilteringProjectsPreparer(gradle.services.get()))
            ...
            return VintageBuildModelController(
                gradle,
                projectsPreparer,
    ...
    class ConfigurationCacheIsolatedProjectsProvider {
        fun createCrossProjectModelAccess(
            ...
            val delegate =
                VintageIsolatedProjectsProvider().createCrossProjectModelAccess(projectRegistry)
    ...
    class ConfigurationCacheModelProvider {
        fun createProjectEvaluator(
            ...
            val evaluator = VintageModelProvider().createProjectEvaluator(
        ...
        fun createLocalComponentRegistry(
            ...
            return VintageModelProvider().createLocalComponentRegistry(
                currentBuild,
    ...
    class VintageModelProvider {
        fun createProjectEvaluator(
            ...
            return LifecycleProjectEvaluator(
                buildOperationExecutor,
                withActionsEvaluator,
                cancellationToken
            )
        }
        ...
        fun createLocalComponentRegistry(
            ...
            return DefaultLocalComponentRegistry(
                currentBuild.buildIdentifier,
                projectStateRegistry,
                calculatedValueContainerFactory,
                provider,
                otherBuildProvider
