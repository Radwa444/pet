...
class ConfigurationCacheRepository(
    ...
    inner class WriteableLayout(
        ...
        override fun fileFor(stateType: StateType): ConfigurationCacheStateFile =
            WriteableConfigurationCacheStateFile(cacheDir.stateFile(stateType), onFileAccess)
    }
    ...
    inner class StoreImpl(
        ...
        override fun <T> createValueStore(
            stateType: StateType,
        ...
        override fun <T : Any> useForStateLoad(
            stateType: StateType,
    ...
    private
    val cleanupMaxAgeDays =
        LeastRecentlyUsedCacheCleanup.DEFAULT_MAX_AGE_IN_DAYS_FOR_RECREATABLE_CACHE_ENTRIES
