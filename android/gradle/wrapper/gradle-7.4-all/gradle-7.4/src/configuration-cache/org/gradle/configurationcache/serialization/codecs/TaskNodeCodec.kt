...
fun collectRegisteredOutputsOf(task: Task): List<RegisteredProperty.OutputFile> {
    ...
    (task.outputs as TaskOutputsInternal).visitRegisteredProperties(object :
...
fun collectRegisteredInputsOf(task: Task): List<RegisteredProperty> {
    ...
    (task.inputs as TaskInputsInternal).visitRegisteredProperties(object :
        PropertyVisitor.Adapter() {
