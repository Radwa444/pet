...
sealed class TransformStepSpec(val transformation: TransformationStep) {
    ...
    class FileDependencies(transformation: TransformationStep, val files: FileCollection) :
        TransformStepSpec(transformation) {
        override fun recreate(): TransformUpstreamDependencies {
...
class FixedUpstreamDependencies(private val dependencies: ArtifactTransformDependencies) :
