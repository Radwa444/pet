...
class FinalizeTransformDependenciesNodeCodec :
    Codec<DefaultTransformUpstreamDependenciesResolver.FinalizeTransformDependencies> {
    ...
    override suspend fun ReadContext.decode(): DefaultTransformUpstreamDependenciesResolver.FinalizeTransformDependencies? {
        ...
        return object :
            DefaultTransformUpstreamDependenciesResolver.FinalizeTransformDependencies() {
