...
class BeanConstructors(
    ...
    private
    val cache: CrossBuildInMemoryCache<Class<*>, Constructor<out Any>> =
    ...
    fun createConstructor(beanType: Class<*>): Constructor<out Any> {
        ...
        if (GroovyObjectSupport::class.java.isAssignableFrom(beanType)) {
            ...
            return newConstructorForSerialization(
                beanType,
                GroovyObjectSupport::class.java.getConstructor()
            )
        } else {
    ...
    private
    fun newConstructorForSerialization(
        beanType: Class<*>,
        constructor: Constructor<*>
    ): Constructor<out Any> =
        ReflectionFactory.getReflectionFactory()
            .newConstructorForSerialization(beanType, constructor)
}
