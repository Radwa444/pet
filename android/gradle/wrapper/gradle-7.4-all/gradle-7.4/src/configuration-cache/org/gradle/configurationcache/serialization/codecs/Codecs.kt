...
class Codecs(
    ...
    val userTypesBindings = Bindings.of {
        ...
        bind(
            InitialTransformationNodeCodec(
                buildOperationExecutor,
                calculatedValueContainerFactory
            )
        )
        bind(
            ChainedTransformationNodeCodec(
                buildOperationExecutor,
                calculatedValueContainerFactory
            )
        )
        ...
        bind(
            LocalFileDependencyBackedArtifactSetCodec(
                instantiator,
                attributesFactory,
                fileCollectionFactory,
                calculatedValueContainerFactory
        ...
        bind(
            IsolateTransformerParametersNodeCodec(
                parameterScheme,
                isolatableFactory,
                buildOperationExecutor,
    ...
    fun BindingsBuilder.providerTypes(
        ...
        val nestedCodec =
            FixedValueReplacingProviderCodec(valueSourceProviderFactory, buildStateRegistry)
