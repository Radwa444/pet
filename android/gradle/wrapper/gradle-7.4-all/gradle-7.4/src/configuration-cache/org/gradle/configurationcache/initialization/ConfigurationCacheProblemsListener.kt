...
interface ConfigurationCacheProblemsListener : TaskExecutionAccessListener,
...
class DefaultConfigurationCacheProblemsListener internal constructor(
    ...
    fun onTaskExecutionAccessProblem(invocationDescription: String, task: TaskInternal) {
        val listener =
            if (task.isCompatibleWithConfigurationCache) problems else problems.forIncompatibleType()
        listener.onProblem(
            PropertyProblem(
