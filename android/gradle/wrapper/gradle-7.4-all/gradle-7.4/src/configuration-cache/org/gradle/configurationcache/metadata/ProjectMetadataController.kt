...
class ProjectMetadataController(
    ...
    override fun read(decoder: Decoder): LocalComponentMetadata {
        ...
        return context.runReadOperation {
            ...
            val metadata = DefaultLocalComponentMetadata(
                moduleVersionId,
                id,
    ...
    suspend fun ReadContext.readConfigurationInto(metadata: DefaultLocalComponentMetadata) {
        ...
        val configuration = metadata.addConfiguration(
            configurationName,
            null,
            emptySet(),
            ImmutableSet.of(configurationName),
            true,
            true,
    ...
    private
    suspend fun ReadContext.readDependenciesInto(
        metadata: DefaultLocalComponentMetadata,
        configuration: BuildableLocalConfigurationMetadata
    ) {
        readCollection {
    ...
    private
    suspend fun ReadContext.readVariantsInto(
        metadata: DefaultLocalComponentMetadata,
    ...
    private
    suspend fun ReadContext.readVariantInto(
        metadata: DefaultLocalComponentMetadata,
        configurationName: String
    ) {
