...
class ConfigurationCacheIO internal constructor(
    ...
    internal
    fun readIncludedBuildStateFrom(
        stateFile: ConfigurationCacheStateFile,
    ...
    fun <T> writeConfigurationCacheState(
        ...
        val (context, codecs) = writerContextFor(
            ...
            build.gradle.owner.displayName.displayName + " state"
        )
    ...
    internal
    fun writerContextFor(
        outputStream: OutputStream,
        profile: String
    ): Pair<DefaultWriteContext, Codecs> =
