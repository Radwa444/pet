...
class ConfigurationCacheFingerprintController internal constructor(
    ...
    private
    val fileCollectionFingerprinter = fingerprinterRegistry.getFingerprinter(
    ...
    abstract class WritingState {
        ...
        open fun maybeStart(
            buildScopedSpoolFile: File,
            projectScopedSpoolFile: File,
            writeContextForOutputStream: (OutputStream) -> DefaultWriteContext
        ): WritingState =
    ...
    inner class Paused(
        ...
        override fun maybeStart(
            ...
            return Writing(
                fingerprintWriter,
                this.buildScopedSpoolFile,
                this.projectScopedSpoolFile
            )
        }
    ...
    fun maybeStartCollectingFingerprint(
        ...
        writingState = writingState.maybeStart(
            buildScopedSpoolFile,
            projectScopedSpoolFile,
    ...
    suspend fun ReadContext.collectFingerprintForReusedProjects(
        host: Host,
