...
object KotlinDslScriptsModelBuilder : ToolingModelBuilder {
    ...
    fun buildFor(parameter: KotlinDslScriptsParameter, project: Project): KotlinDslScriptsModel {
        ...
        return StandardKotlinDslScriptsModel(
            parameter.scriptFiles,
            commonModel,
            dehydratedScriptModels
        )
    }
}
...
fun dehydrateScriptModels(
    ...
    val commonModel =
        CommonKotlinDslScriptModel(commonClassPath, commonSourcePath, commonImplicitImports)
...
fun Project.collectKotlinDslScripts(): List<File> = sequence<File> {
    ...
    val settingsScriptFile =
        File((project as ProjectInternal).gradle.settings.settingsScript.fileName)
