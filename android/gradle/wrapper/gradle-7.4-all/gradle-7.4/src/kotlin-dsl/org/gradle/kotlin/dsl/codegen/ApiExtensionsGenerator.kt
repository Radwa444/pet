...
private
fun writeExtensionsTo(
    outputFile: File,
    packageName: String,
    extensions: List<KotlinExtensionFunction>
): Unit =
...
data class KotlinExtensionFunction(
    ...
    fun toKotlinString(): String = StringBuilder().apply {
        ...
        if (targetType.typeParameters.isNotEmpty()) append(
            targetType.typeParameters.toTypeArgumentsString(
                targetType
            )
        )
        append(".")
