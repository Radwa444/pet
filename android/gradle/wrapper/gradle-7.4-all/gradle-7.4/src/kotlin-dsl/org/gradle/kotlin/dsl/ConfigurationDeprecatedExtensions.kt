...
@Deprecated(
    deprecationMessage,
    replaceWith = ReplaceWith("get().getTaskDependencyFromProjectDependency(useDependedOn, taskName)")
)
fun <T : Configuration> NamedDomainObjectProvider<T>.getTaskDependencyFromProjectDependency(
...
@Deprecated(
    deprecationMessage,
    replaceWith = ReplaceWith("get().addToAntBuilder(builder, nodeName, type)")
)
fun <T : Configuration> NamedDomainObjectProvider<T>.addToAntBuilder(
    builder: Any,
    nodeName: String,
...
@Deprecated(
    deprecationMessage,
    replaceWith = ReplaceWith("get().addToAntBuilder(builder, nodeName)")
)
fun <T : Configuration> NamedDomainObjectProvider<T>.addToAntBuilder(
    builder: Any,
    nodeName: String
