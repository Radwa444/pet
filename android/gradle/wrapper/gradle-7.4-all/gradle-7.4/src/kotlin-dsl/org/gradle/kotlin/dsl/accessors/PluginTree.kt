...
sealed class PluginTree {
    ...
    data class PluginGroup(val path: List<String>, val plugins: Map<String, PluginTree>) :
        PluginTree()
    ...
    companion object {
        ...
        private
        fun pluginTreeForGroup(
            groupPath: List<String>,
            root: MutableMap<String, PluginTree>
        ): MutableMap<String, PluginTree>? {
            var branch = root
