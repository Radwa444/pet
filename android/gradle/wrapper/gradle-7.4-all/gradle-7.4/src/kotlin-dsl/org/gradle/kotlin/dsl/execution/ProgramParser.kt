...
object ProgramParser {
    ...
    fun parse(source: ProgramSource, kind: ProgramKind, target: ProgramTarget): Packaged<Program> =
        try {
...
fun checkForTopLevelBlockOrder(
    ...
    val pluginManagementBlock =
        topLevelBlocks.find { it.identifier == TopLevelBlockId.pluginManagement } ?: return
