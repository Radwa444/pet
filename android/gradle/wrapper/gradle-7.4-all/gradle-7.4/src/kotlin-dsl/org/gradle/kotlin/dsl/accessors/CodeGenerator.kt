...
fun extensionAccessor(spec: TypedAccessorSpec): String = spec.run {
    when (type) {
        ...
        is TypeAccessibility.Inaccessible -> inaccessibleExtensionAccessorFor(
            receiver.type.kotlinString,
            name,
            type
        )
...
fun conventionAccessor(spec: TypedAccessorSpec): String = spec.run {
    when (type) {
        ...
        is TypeAccessibility.Inaccessible -> inaccessibleConventionAccessorFor(
            receiver.type.kotlinString,
            name,
            type
        )
...
private
fun accessibleConventionAccessorFor(
    targetType: String,
    name: AccessorNameSpec,
    type: String
): String = name.run {
...
fun existingTaskAccessor(spec: TypedAccessorSpec): String = spec.run {
    when (type) {
        is TypeAccessibility.Accessible -> accessibleExistingTaskAccessorFor(
            name,
            type.type.kotlinString
        )
...
private
fun inaccessibleExistingTaskAccessorFor(
    name: AccessorNameSpec,
    typeAccess: TypeAccessibility.Inaccessible
): String = name.run {
    """
...
private
fun accessibleExistingContainerElementAccessorFor(
    targetType: String,
    name: AccessorNameSpec,
    type: String
): String = name.run {
...
private
fun documentInaccessibilityReasons(
    name: AccessorNameSpec,
    typeAccess: TypeAccessibility.Inaccessible
): String =
