...
object SourcePathProvider {
    ...
    fun sourcePathFor(
        ...
        val gradleSourceRoots =
            gradleHomeDir?.let { sourceRootsOf(it, sourceDistributionResolver) } ?: emptyList()
    ...
    fun sourceRootsOf(
        ...
        gradleInstallationSources(gradleInstallation) ?: downloadedSources(
            sourceDistributionResolver
        )
