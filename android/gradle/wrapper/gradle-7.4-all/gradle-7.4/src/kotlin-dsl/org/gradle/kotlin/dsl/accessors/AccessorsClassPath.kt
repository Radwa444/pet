...
class GenerateProjectAccessors(
    ...
    override fun identify(
        identityInputs: Map<String, ValueSnapshot>,
        identityFileInputs: Map<String, CurrentFileCollectionFingerprint>
    ): UnitOfWork.Identity {
...
sealed class TypeAccessibility {
    ...
    data class Inaccessible(val type: SchemaType, val reasons: List<InaccessibilityReason>) :
        TypeAccessibility()
}
