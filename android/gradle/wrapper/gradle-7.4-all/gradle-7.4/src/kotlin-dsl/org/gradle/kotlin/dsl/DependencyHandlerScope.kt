...
private constructor(
    ...
    @Deprecated(
        replaceWith = ReplaceWith("constraints"),
        message = "This method shouldn't be called because the most specific variant should be preferred by the Kotlin compiler",
     ...
     * @see [DependencyHandler.add]
     */
    inline operator fun <T : ModuleDependency> String.invoke(
        dependency: T,
    ...
    operator fun Configuration.invoke(
        ...
        create(group, name, version, configuration, classifier, ext).apply {
            add(
                this@invoke.name,
                this
            )
     ...
     * @see [DependencyHandler.add]
     */
    inline operator fun <T : ModuleDependency> Configuration.invoke(
        dependency: T,
        dependencyConfiguration: T.() -> Unit
    ): T =
