...
fun fetchKotlinBuildScriptModelFor(parameters: FetchParameters): KotlinBuildScriptModel {
    ...
    val effectiveProjectDir =
        buildSrcProjectDirOf(parameters.scriptFile, parameters.importedProjectDir)
    ...
    if (scriptModel.enclosingScriptProjectDir == null && hasProjectDependentClassPath(parameters.scriptFile)) {
        val externalProjectRoot =
            projectRootOf(parameters.scriptFile, parameters.importedProjectDir)
