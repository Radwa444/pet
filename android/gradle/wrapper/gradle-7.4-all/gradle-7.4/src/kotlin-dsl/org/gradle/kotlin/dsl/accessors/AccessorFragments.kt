                ...
                writer.writeFunctionOf(
                    ...
                    parameters = {
                        ...
                        visitParameter(
                            ...
                            actionTypeOf(GradleType.externalModuleDependency)
                        )
                    },
                    signature = signature
                )
        ...
        AccessorFragment(
            ...
            bytecode = {
                publicStaticMaybeDeprecatedMethod(signature, config) {
                    ...
                    ALOAD(1)
                    INVOKEINTERFACE(
                        GradleTypeName.dependencyHandler,
                        "add",
                        "(Ljava/lang/String;Ljava/lang/Object;)Lorg/gradle/api/artifacts/Dependency;"
                    )
                    ARETURN()
                }
            },
        ...
        AccessorFragment(
            ...
            bytecode = {
                publicStaticMaybeDeprecatedMethod(signature, config) {
                    ...
                    ALOAD(1)
                    INVOKEINTERFACE(
                        GradleTypeName.dependencyConstraintHandler,
                        "add",
                        "(Ljava/lang/String;Ljava/lang/Object;)Lorg/gradle/api/artifacts/DependencyConstraint;"
                    )
                    ARETURN()
                }
            },
            ...
            bytecode = {
                publicStaticMaybeDeprecatedMethod(signature, config) {
                    ...
                    INVOKEINTERFACE(
                        GradleTypeName.dependencyConstraintHandler,
                        "add",
                        "(Ljava/lang/String;Ljava/lang/Object;Lorg/gradle/api/Action;)Lorg/gradle/api/artifacts/DependencyConstraint;"
                    )
                    ARETURN()
                }
            },
        ...
        AccessorFragment(
            ...
            bytecode = {
                publicStaticMethod(signature) {
                    ...
                    ALOAD(1)
                    INVOKEINTERFACE(
                        GradleTypeName.artifactHandler,
                        "add",
                        "(Ljava/lang/String;Ljava/lang/Object;)Lorg/gradle/api/artifacts/PublishArtifact;"
                    )
                    ARETURN()
                }
            },
            ...
            bytecode = {
                publicStaticMethod(signature) {
                    ...
                    INVOKEINTERFACE(
                        GradleTypeName.artifactHandler,
                        "add",
                        "(Ljava/lang/String;Ljava/lang/Object;Lorg/gradle/api/Action;)Lorg/gradle/api/artifacts/PublishArtifact;"
                    )
                    ARETURN()
                }
            },
            metadata = {
                writer.writeFunctionOf(
                    ...
                    parameters = {
                        ...
                        visitParameter(
                            "configureAction",
                            actionTypeOf(GradleType.configurablePublishArtifact)
                        )
                    },
                    signature = signature
                )
...
private
fun MethodVisitor.loadConventionOf(
    name: AccessorNameSpec,
    returnType: TypeAccessibility,
    jvmReturnType: InternalName
) {
    ALOAD(0)
    LDC(name.original)
    invokeRuntime(
...
private
fun accessibleTypesFor(typeAccessibility: TypeAccessibility): Pair<KmTypeBuilder, InternalName> =
    when (typeAccessibility) {
...
private
fun ConfigurationEntry<AccessorNameSpec>.getDeclarationDeprecationMessage() =
    if (hasDeclarationDeprecations()) {
        val deprecationType = ConfigurationDeprecationType.DEPENDENCY_DECLARATION
        val summary =
            "The ${target.original} configuration has been deprecated for ${deprecationType.displayName()}."
        val suggestion = "Please ${deprecationType.usage} the ${
            dependencyDeclarationAlternatives.map(::quote).joinToString(" or ")
