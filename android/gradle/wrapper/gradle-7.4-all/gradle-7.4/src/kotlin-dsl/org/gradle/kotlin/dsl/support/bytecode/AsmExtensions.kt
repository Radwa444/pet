...
internal
fun MethodVisitor.INVOKESPECIAL(
    owner: InternalName,
    name: String,
    desc: String,
    itf: Boolean = false
...
internal
fun MethodVisitor.INVOKEINTERFACE(
    owner: InternalName,
    name: String,
    desc: String,
    itf: Boolean = true
...
private
fun MethodVisitor.visitMethodInsn_(
    opcode: Int,
    owner: InternalName,
    name: String,
    desc: String,
...
fun MethodVisitor.GETSTATIC(field: KProperty<*>) {
    ...
    val owner =
        (field.owner as kotlin.jvm.internal.ClassBasedDeclarationContainer).jClass.internalName
    GETSTATIC(owner, field.name, "L$owner;")
}
