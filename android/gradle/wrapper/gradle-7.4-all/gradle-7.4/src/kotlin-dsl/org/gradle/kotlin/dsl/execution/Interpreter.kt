...
class Interpreter(val host: Host) {
    ...
    interface Host {
        ...
        fun serviceRegistryFor(programTarget: ProgramTarget, target: Any): ServiceRegistry =
            when (programTarget) {
    ...
    open inner class ProgramHost : ExecutableProgram.Host {
        ...
        override fun accessorsClassPathFor(scriptHost: KotlinScriptHost<*>): ClassPath {
            ...
            val projectAccessorsClassPathGenerator =
                ...
                host.cachedDirFor(
                    ...
                    startCompilerOperationFor(scriptSource, scriptTemplateId).use {
                        ...
                        scriptSource.withLocationAwareExceptionHandling {
                            ...
                            scriptHost.temporaryFileProvider.withTemporaryScriptFileFor(
                                originalScriptPath,
            ...
            try {
                ...
                throw LocationAwareException(
                    GradleScriptException(
                        "Failed to load compiled script from classpath ${compiledScript.classPath}.",
                        e
                    ),
...
private
fun locationAwareExceptionHandlingFor(
    e: Throwable,
    scriptClass: Class<*>,
    scriptSource: ScriptSource
): Nothing {
