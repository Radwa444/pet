...
object EditorReports {
    ...
    const val locationAwareEditorHintsPropertyName =
        "org.gradle.kotlin.dsl.internal.locationAwareEditorHints"
}
...
object EditorMessages {
    ...
    @VisibleForTesting
    const val failureUsingPrevious =
        "Script dependencies resolution failed, $usingPrevious, $ideLogs"
    ...
    const val buildConfigurationFailedUsingPrevious =
        "Build configuration failed, $usingPrevious, $gradleTasks"

    const val buildConfigurationFailedInCurrentScript =
        "This script caused build configuration to fail, $gradleTasks"
