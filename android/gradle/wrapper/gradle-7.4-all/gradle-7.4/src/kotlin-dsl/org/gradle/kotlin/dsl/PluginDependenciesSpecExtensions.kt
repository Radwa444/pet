...
val PluginDependenciesSpec.`gradle-enterprise`: PluginDependencySpec
    get() = this.id(AutoAppliedGradleEnterprisePlugin.ID.id)
        .version(AutoAppliedGradleEnterprisePlugin.VERSION)
...
val PluginDependenciesSpec.`build-scan`: PluginDependencySpec
    get() = this.id(AutoAppliedGradleEnterprisePlugin.BUILD_SCAN_PLUGIN_ID.id)
        .version(AutoAppliedGradleEnterprisePlugin.VERSION)
